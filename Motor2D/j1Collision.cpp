...
j1Collision::j1Collision()
{
	...
	matrix[COLLIDER_FLOOR][COLLIDER_COLLECTIBLE] = false;
	...
	matrix[COLLIDER_JUMPABLE][COLLIDER_COLLECTIBLE] = false;
	...
	matrix[COLLIDER_COLLECTIBLE][COLLIDER_FLOOR] = false;
...
void j1Collision::DebugDraw()
{
	...
	for(uint i = 0; i < MAX_COLLIDERS; ++i)
	{
		...
		case COLLIDER_FLOOR: // blue
			...
			break;
		case COLLIDER_COLLECTIBLE: // lightgrey
			App->render->DrawQuad(colliders[i]->rect, 211, 211, 211, alpha);
			break;
