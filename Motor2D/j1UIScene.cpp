...
bool j1UIScene::Start()
{
	...
	menu* mainMenu = new menu(INGAME_MENU);
	{
		...
		UI_element* slider = App->gui->createSlider(50, 200, NULL, { 0, 259, 638, 31 }, { 0, 290, 638, 31 }, sliderButton, big_buttons_font, yellow_color, 0, 168, 50);*/
		...
		exit_text->setDragable(true, true);
		...
		/*new_text = App->gui->createText("IN GAME", 0, 0, big_buttons_font, yellow_color);
		new_text->setOutlined(true);*/
	...
	menu* pauseMenu = new menu(PAUSE_MENU);
	{
		...
		//test = App->gui->createText("PAUSE MENU", 0, 0, big_buttons_font, yellow_color);
	...
	menu* settingsMenu = new menu(SETTINGS_MENU);
	{
		...
		UI_element* music_slider = App->gui->createSlider(0, 0, NULL, { 0, 259, 638, 31 }, { 0, 290, 638, 31 }, music_slider_butt, mid_texts_font, yellow_color, 0, 168, 50);
		...
		UI_element* fx_slider = App->gui->createSlider(0, 0, NULL, { 0, 259, 638, 31 }, { 0, 290, 638, 31 }, fx_slider_butt, mid_texts_font, yellow_color, 0, 168, 50);
